...
* Problem: 
  Binary Search: Search a value in a sorted array.
*/

// Time: O(log n)

const binarySearch = (arr, value) => {
 return binarySearch2(arr, value, 0, arr.length - 1);
};

const binarySearch2 = (arr, value, start, end) => {
 if (start > end) {
   return false;
 }
...
const Landing = () => {
  ...
  return (
    <>
      ...
      <a
        href="https://github.com/prasundante123/CodeBuns_Project"
        title=""
        class="github-corner"
        target="_blank"
        rel="noreferrer"
